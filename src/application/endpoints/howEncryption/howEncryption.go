...
func buildMessage() *telegram.MessageBuilder {
	...
	mb.WriteString("Твоя приватность защищена на уровне архитектуры", telegram.TextFormat{Type: telegram.FormatBold}).
		...
		WriteNextLine("🐾", telegram.TextFormat{Type: telegram.FormatLink}.WithCustomEmojiID("6062215036858797217")).
		WriteNextLine("Многослойное шифрование: При регистрации тебе создается персональный ключ. Он сам зашифрован общим мастер-ключом, который хранится в изолированной среде.").WriteString("🐾", telegram.TextFormat{Type: telegram.FormatLink}.WithCustomEmojiID("6062215036858797217")).WriteString(
		...
		"👩‍💻", telegram.TextFormat{Type: telegram.FormatLink}.WithCustomEmojiID("6325758868706035396"),
	)
